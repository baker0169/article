...
if ($try === TRUE) {
	echo "<script>alert('update successfully!');window.location.href= 'cms-modify.php?id=$id'</script>";
} else {
	echo "Error: ".$updatesql."<br>".$conn->error;
	echo "<script>alert('failed to update !');window.location.href= 'cms-modify.php?id=$id'</script>";
}
